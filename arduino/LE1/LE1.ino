...
IPAddress server(192,168,0,13);  // numeric IP for server (no DNS) (reduce sketch size)
IPAddress ip(192,168,0,15);      //numeric IP of the ETHERNET shield (STATIC)
...
void loop() {
   ...
   tone(BUZZER, 1000,300);
    ...
    // Make a HTTP request:
     ...
     client.print("GET /rfidmonitor/pages/updateLE1.php?id=");
    client.print(id);   //dont make these println
